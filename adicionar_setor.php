...
<div class="container" style="margin-top: 40px;width: 500px;">
	...
	<h4>Cadastro Setor</h4>
	<form action="_inserir_setor.php" method="post">
		<label style="margin-bottom: 10px;">Setor</label>
		<div class="form-group">
			<input type="text" name="setor" class="form-control" placeholder="Digite o setor ou operação" autocomplete="off">
		</div>
		<div style="text-align: right;">
		<br>
